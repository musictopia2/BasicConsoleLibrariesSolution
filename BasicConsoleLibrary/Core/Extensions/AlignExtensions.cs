...
public static class AlignExtensions
{
    ...
    /// <returns>The same instance so that multiple calls can be chained.</returns>
    public static Align VerticalAlignment(this Align align, EnumVerticalAlignment? vertical)
    {
        if (align is null)
        {
            throw new ArgumentNullException(nameof(align));
    ...
    public static Align TopAligned(this Align align)
    {
        ...
        align.Vertical = EnumVerticalAlignment.Top;
        return align;
    }
    ...
    public static Align MiddleAligned(this Align align)
    {
        ...
        align.Vertical = EnumVerticalAlignment.Middle;
        return align;
    }
    ...
    public static Align BottomAligned(this Align align)
    {
        ...
        align.Vertical = EnumVerticalAlignment.Bottom;
        return align;
    }
}