...
public static class TableExtensions
{
    extension (ManualTable table)
    {
        ...
        public ManualTable AddColumns(params TableColumn[] columns)
        {
        ...
        /// <returns>The same instance so that multiple calls can be chained.</returns>
        public ManualTable AddRow(IEnumerable<IRenderable> columns)
        {
            ArgumentNullException.ThrowIfNull(table);
        ...
        /// <param name="columns">The row columns to add.</param>
        /// <returns>The same instance so that multiple calls can be chained.</returns>
        public ManualTable AddRow(params IRenderable[] columns)
        {
            ArgumentNullException.ThrowIfNull(table);
        ...
        /// </summary>
        /// <returns>The same instance so that multiple calls can be chained.</returns>
        public ManualTable AddEmptyRow()
        {
            ArgumentNullException.ThrowIfNull(table);
        ...
        /// <returns>The same instance so that multiple calls can be chained.</returns>
        public ManualTable AddColumn(string column, Action<TableColumn>? configure = null)
        {
            ArgumentNullException.ThrowIfNull(table);
        ...
        /// <param name="columns">The columns to add.</param>
        /// <returns>The same instance so that multiple calls can be chained.</returns>
        public ManualTable AddColumns(params string[] columns)
        {
            ArgumentNullException.ThrowIfNull(table);
        ...
        /// <param name="columns">The row columns to add.</param>
        /// <returns>The same instance so that multiple calls can be chained.</returns>
        public ManualTable AddRow(params string[] columns)
        {
            ArgumentNullException.ThrowIfNull(table);
        ...
        /// <param name="columns">The row columns to add.</param>
        /// <returns>The same instance so that multiple calls can be chained.</returns>
        public ManualTable InsertRow(int index, IEnumerable<IRenderable> columns)
        {
            ArgumentNullException.ThrowIfNull(table);
        ...
        /// <returns>The same instance so that multiple calls can be chained.</returns>
        public ManualTable UpdateCell(int rowIndex, int columnIndex, IRenderable cellData)
        {
            ArgumentNullException.ThrowIfNull(table);
        ...
        /// <param name="cellData">New cell data.</param>
        /// <returns>The same instance so that multiple calls can be chained.</returns>
        public ManualTable UpdateCell(int rowIndex, int columnIndex, string cellData)
        {
            ArgumentNullException.ThrowIfNull(table);
        ...
        /// <param name="columns">The row columns to add.</param>
        /// <returns>The same instance so that multiple calls can be chained.</returns>
        public ManualTable InsertRow(int index, params IRenderable[] columns)
        {
            ArgumentNullException.ThrowIfNull(table);
        ...
        /// <param name="columns">The row columns to add.</param>
        /// <returns>The same instance so that multiple calls can be chained.</returns>
        public ManualTable InsertRow(int index, params string[] columns)
        {
            ArgumentNullException.ThrowIfNull(table);
        ...
        /// <returns>The same instance so that multiple calls can be chained.</returns>
        public ManualTable RemoveRow(int index)
        {
            ArgumentNullException.ThrowIfNull(table);
        ...
        /// <returns>The same instance so that multiple calls can be chained.</returns>
        public ManualTable Width(int? width)
        {
            ArgumentNullException.ThrowIfNull(table);
        ...
        /// </summary>
        /// <returns>The same instance so that multiple calls can be chained.</returns>
        public ManualTable ShowHeaders()
        {
            ArgumentNullException.ThrowIfNull(table);
        ...
        /// </summary>
        /// <returns>The same instance so that multiple calls can be chained.</returns>
        public ManualTable HideHeaders()
        {
            ArgumentNullException.ThrowIfNull(table);
        ...
        /// </summary>
        /// <returns>The same instance so that multiple calls can be chained.</returns>
        public ManualTable ShowRowSeparators()
        {
            ArgumentNullException.ThrowIfNull(table);
        ...
        /// </summary>
        /// <returns>The same instance so that multiple calls can be chained.</returns>
        public ManualTable HideRowSeparators()
        {
            ArgumentNullException.ThrowIfNull(table);
        ...
        /// </summary>
        /// <returns>The same instance so that multiple calls can be chained.</returns>
        public ManualTable ShowFooters()
        {
            ArgumentNullException.ThrowIfNull(table);
        ...
        /// </summary>
        /// <returns>The same instance so that multiple calls can be chained.</returns>
        public ManualTable HideFooters()
        {
            ArgumentNullException.ThrowIfNull(table);
        ...
        /// <returns>The same instance so that multiple calls can be chained.</returns>
        public ManualTable Title(string text, Style? style = null)
        {
            ArgumentNullException.ThrowIfNull(table);
        ...
        /// <returns>The same instance so that multiple calls can be chained.</returns>
        public ManualTable Title(TableTitle title)
        {
            ArgumentNullException.ThrowIfNull(table);
        ...
        /// <returns>The same instance so that multiple calls can be chained.</returns>
        public ManualTable Caption(string text, Style? style = null)
        {
            ArgumentNullException.ThrowIfNull(table);
        ...
        /// <returns>The same instance so that multiple calls can be chained.</returns>
        public ManualTable Caption(TableTitle caption)
        {
            ArgumentNullException.ThrowIfNull(table);
